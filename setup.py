...
GITHUB_URL = "https://github.com/miquelmassot/pitop_zeroros"
...
setup(
    name="pitop_zeroros",
    version="0.0.1",
    description="Pi-Top driver using ZeroROS middleware",
    ...
    entry_points={
        "console_scripts": [
            "pitop_zeroros = pitop_zeroros.pitop_zeroros:main",
        ],
    },
)
